...
#ifndef ExN04aEventAction_h
#define ExN04aEventAction_h 1
...
class ExN04EventActionMessenger;
class ExN04AnalysisManager;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
class ExN04aEventAction : public G4UserEventAction {

  public:
    aEventAction(ExN04RunAction*, ExN04PrimaryGeneratorAction*);
  ...
  private:
    ...
    G4int saveHitsFlag;         
    G4int printModulo;                         
    ExN04EventActionMessenger*  eventMessenger;

    ExN04RunAction*    runAct;  //pointer to run action
    ExN04PrimaryGeneratorAction* genAction; // pointer to particle generator
