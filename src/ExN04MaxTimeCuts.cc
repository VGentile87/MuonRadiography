...
ExN04MaxTimeCuts::ExN04MaxTimeCuts(const G4String& aName)
...
ExN04MaxTimeCuts::ExN04MaxTimeCuts(ExN04MaxTimeCuts&)
 : ExN04SpecialCuts()
{}

 
G4double ExN04MaxTimeCuts::PostStepGetPhysicalInteractionLength(
