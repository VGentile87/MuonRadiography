...
//
//
// $Id: B4MinEkineCuts.cc 69148 2013-04-19 10:35:21Z gcosmo $
//
// 
// --------------------------------------------------------------
...
ExN04MinEkineCuts::ExN04MinEkineCuts(const G4String& aName)
  : ExN04SpecialCuts(aName)
{
    if (verboseLevel>1) {
...
ExN04MinEkineCuts::ExN04MinEkineCuts(ExN04MinEkineCuts&)
  : ExN04SpecialCuts()
{}


G4double ExN04MinEkineCuts::PostStepGetPhysicalInteractionLength(
