...
// construct Bosons://///////////////////////////////////////////////////
void ExN04PhysicsList::ConstructMyBosons()
{
  // pseudo-particles
...
// construct Leptons://///////////////////////////////////////////////////
void ExN04PhysicsList::ConstructMyLeptons()
{
  // leptons
...
// construct Hadrons://///////////////////////////////////////////////////
void ExN04PhysicsList::ConstructMyHadrons()
{
 //  mesons
...
void ExN04PhysicsList::ConstructMyShortLiveds()
{
...
// Transportation ///////////////////////////////////////////////////////////
#include "ExN04MaxTimeCuts.hh"
#include "ExN04MinEkineCuts.hh"
#include "G4StepLimiter.hh"

void ExN04PhysicsList::AddTransportation() {
  ...
  while( (*particleIterator)() ){
    ...
    if(particleName == "neutron") 
      pmanager->AddDiscreteProcess(new ExN04MaxTimeCuts());
...
void ExN04PhysicsList::ConstructOp() 
{
...
void ExN04PhysicsList::SetCuts()
{
  ...
  G4double lowlimit=100*eV;//5.8*eV;  
